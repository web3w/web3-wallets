...
import {ChainInfo, LimitedCallSpec, WalletInfo} from "../types";
import {BigNumber} from "../agentTypes"
import {getProvider} from "./provider";
import chainNodes from '../constants/chain'
...
export function getChainInfo(chinaId: number): ChainInfo {
    if (chainNodes[chinaId]) {
        return chainNodes[chinaId]
    } else {
...
export async function getChainRpcUrl(chinaId: number, best?: false): Promise<string> {
